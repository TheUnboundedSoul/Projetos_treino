...
// displaying brands in sidenav
 function getbrands() {
    ...
    while($row_data = mysqli_fetch_assoc($result_brands)) {
        ...
        echo "<li class='vab-item'>
            <a href='index.php?brand=$brand_id' class='nav-link'><h4>$brand_title</h4></a>
        </li>";
    }
 }
...
function getcategories() {
    ...
    while($row_data = mysqli_fetch_assoc($result_categories)) {
        ...
        echo "<li class='vab-item'>
            <a href='index.php?category=$category_id' class='nav-link'><h4>$category_title</h4></a>
        </li>";
    }
}
        ...
        if(!isset($_GET['edit_account'])) {
            if(!isset($_GET['my_orders'])) {
                if(!isset($_GET['delete_account'])) {
                    ...
                    if($row_count>0) {
                        echo "
                        <h3 class='text-center text-success my-5'>You have <span class='text-danger'>$row_count</span> pending orders</h3>
                        <p class='text-center'><a href='profile.php?my_orders'>Order Details</a></p>
                        ";
                    } else {
                        echo "
                        <h3 class='text-center text-success my-5'>You have zero pending orders</h3>
