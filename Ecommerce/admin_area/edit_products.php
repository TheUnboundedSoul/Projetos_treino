...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <select name="product_category" id="form-select">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image1" name="product_image1" value="<?php echo $product_image1 ?>" class="form-control w-90 m-auto" required="required">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image2" name="product_image2" <?php echo $product_image2 ?> class="form-control w-90 m-auto" required="required">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <div class="d-flex">
                <input type="file" id="product_image3" name="product_image3" <?php echo $product_image3?> class="form-control w-90 m-auto" required="required">
