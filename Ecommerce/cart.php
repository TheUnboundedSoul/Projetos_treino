                ...
                <table class="table table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="submit" value="Update car" class="bg-info px-3 py-2 border-0 mx-3" name="update_cart">
                                <!--<button class="bg-info px-3 py-2 border-0 mx-3">Remove</button>-->
                                <input type="submit" value="Remove car" class="bg-info px-3 py-2 border-0 mx-3" name="remove_cart">
                            </td>
                        </tr>
                        <?php 
                                }
